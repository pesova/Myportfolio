...
<body id="page-top">
            ...
            <div class="text-center" data-aos="fade-in">
                ...
                <div id="AboutMe">
                    ...
                    <p style="color: #e1e1ee" data-aos="zoom-in-up">
                        <b>Hi, I'm Osueke Pesova, A Full Stack Developer from Imo state, Nigeria. I have been developing and learning web applications for the last 4 years. I'm super passionate about development and how the web works in general.</b>
                    </p>
    ...
    <section style="background-color: #c8c2e9" class="page-section" id="timeline">
        <div class="container">
            ...
            <ul class="timeline">
                <li>
                    <div class="timeline-image" data-aos="zoom-out-right"><img class="rounded-circle img-fluid" src="assets/img/about/mine/Prof.jpg" alt="" /></div>
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image" data-aos="zoom-out-left"><img class="rounded-circle img-fluid" src="assets/img/about/mine/Prof1.jpg" alt="" /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                ...
                <li>
                    <div class="timeline-image" data-aos="zoom-out-right"><img class="rounded-circle img-fluid" src="assets/img/about/mine/startng.jpg" alt="" /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                ...
                <li class="timeline-inverted">
                    <div class="timeline-image" data-aos="zoom-out-left"><img class="rounded-circle img-fluid" src="assets/img/about/mine/HNG intern1.png" alt="" /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                ...
                <li>
                    <div class="timeline-image" data-aos="zoom-out-right"><img class="rounded-circle img-fluid" src="assets/img/about/mine/wedprof.jpg" alt="" /></div>
                    <div class="timeline-panel">
                        <div class="timeline-heading">
    ...
    <section style="background-color: #d4cfec" class="page-section" id="Projects">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase" data-aos="fade-down-left">
                    <a style="color: #15037c; text-decoration:none" href="javascript:void(0)">P</a><a style="color: #1900a7; text-decoration:none" href="javascript:void(0)">R</a><a style="color: #2a0fc5; text-decoration:none" href="javascript:void(0)">O</a><a style="color: #432ad3; text-decoration:none"
                        href="javascript:void(0)">J</a><a style="color: #6b54eb; text-decoration:none" href="javascript:void(0)">E</a><a style="color: #9585f0; text-decoration:none" href="javascript:void(0)">CTS</a>
                </h2>
    ...
    <section style="background-color: #e9e7f3" class="page-section" id="services">
        <div class="container">
            <div class="text-center" >
                <h2 class="section-heading text-uppercase" data-aos="fade-down-right">Capabilities</h2>
                <h3 class="section-subheading text-muted" data-aos="fade-down-right">Things I Can Do</h3>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4" >
                    ...
                    <p class="text-muted" data-aos="zoom-out-down">I build sites with PhP and also using Laravel Framework both creating and consuming APIs, I also have little knowledge on python and Devops. And am a Fast Learner that has experienced Learning and working under Pressure at the same
                        time
                    </p>
                </div>
                <div class="col-md-4" >
